...
function Sidebar() {
  ...
  const menus = [
    ...
    { name: "Customers", link: "/", icon: FaHandHoldingDollar },
          ...
          <div className="mt-4 flex flex-col gap-4 relative">
            ...
            {menus?.map((menu, i) => (
              ...
              // style={{paddingRight:'75%'}}
                ...
                className={` ${
                  menu?.margin && "mt-5"
                } group flex items-center text-sm  gap-x-3.5 font-medium p-2 hover:bg-gray-800 rounded-md`}
              >
                <div className="mx-auto">{React.createElement(menu?.icon, { size: "20" })}</div>
                <h2
                  style={{
