        ...
        <div className=''>
            {
                ...
                path.length > 0 && <Link to="/" className='capitalize hover:underline text-black'>Dashboard</Link>
            }
            {
                ...
                path.map((name, index) => {
                    ...
                    return (
                        ...
                        index === path.length - 1?
                            <span key={index} className='capitalize text-gray-500'>&nbsp;/&nbsp;{name}</span>
                            :
                            // Render the other breadcrumb segments with a link.
                            <span key={index} className=''>
                                &nbsp;/ <Link to={breadcrumbPath} className='capitalize hover:underline text-black'>{name}</Link>
                            </span>
                    )
                })
            }
