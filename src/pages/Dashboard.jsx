    ...
    <div>
      {loggedIn === false ? (
        ...
        <div className="grid grid-cols-8 gap-4">
          ...
          <div className="col-span-4 row-span-2 rounded-rounded bg-background p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <select
                ...
                className="mt-1 block w-[13%] rounded-md border bg-background text-foreground border-gray-300 px-2 py-2 text-base focus:outline-none sm:text-sm"
              >
          ...
          <div className="col-span-4 rounded-rounded bg-background text-foreground p-5">
            {" "}
            Recent Invoices
          </div>
